...
mutations = [
    {'id': 'rpoB_S450L', 'gene': 'rpoB', 'position': 450, 'ref': 'S', 'alt': 'L', 'drug': 'rifampin', 'level': 'high'},
    {'id': 'rpoB_D435V', 'gene': 'rpoB', 'position': 435, 'ref': 'D', 'alt': 'V', 'drug': 'rifampin', 'level': 'high'},
    {'id': 'rpoB_H445Y', 'gene': 'rpoB', 'position': 445, 'ref': 'H', 'alt': 'Y', 'drug': 'rifampin', 'level': 'high'},
    {'id': 'rpoB_H445D', 'gene': 'rpoB', 'position': 445, 'ref': 'H', 'alt': 'D', 'drug': 'rifampin', 'level': 'high'},
    {'id': 'rpoB_L430P', 'gene': 'rpoB', 'position': 430, 'ref': 'L', 'alt': 'P', 'drug': 'rifampin', 'level': 'moderate'},
    {'id': 'katG_S315T', 'gene': 'katG', 'position': 315, 'ref': 'S', 'alt': 'T', 'drug': 'isoniazid', 'level': 'high'},
    {'id': 'katG_S315N', 'gene': 'katG', 'position': 315, 'ref': 'S', 'alt': 'N', 'drug': 'isoniazid', 'level': 'high'},
    {'id': 'katG_S315I', 'gene': 'katG', 'position': 315, 'ref': 'S', 'alt': 'I', 'drug': 'isoniazid', 'level': 'high'},
    {'id': 'inhA_-15C>T', 'gene': 'inhA', 'position': -15, 'ref': 'C', 'alt': 'T', 'drug': 'isoniazid', 'level': 'low'},
    {'id': 'inhA_-8T>C', 'gene': 'inhA', 'position': -8, 'ref': 'T', 'alt': 'C', 'drug': 'isoniazid', 'level': 'low'},
    {'id': 'embB_M306V', 'gene': 'embB', 'position': 306, 'ref': 'M', 'alt': 'V', 'drug': 'ethambutol', 'level': 'high'},
    {'id': 'embB_M306I', 'gene': 'embB', 'position': 306, 'ref': 'M', 'alt': 'I', 'drug': 'ethambutol', 'level': 'high'},
    {'id': 'pncA_H57D', 'gene': 'pncA', 'position': 57, 'ref': 'H', 'alt': 'D', 'drug': 'pyrazinamide', 'level': 'high'},
    {'id': 'pncA_W68R', 'gene': 'pncA', 'position': 68, 'ref': 'W', 'alt': 'R', 'drug': 'pyrazinamide', 'level': 'high'},
    {'id': 'gyrA_D94G', 'gene': 'gyrA', 'position': 94, 'ref': 'D', 'alt': 'G', 'drug': 'levofloxacin', 'level': 'high'},
    {'id': 'gyrA_D94N', 'gene': 'gyrA', 'position': 94, 'ref': 'D', 'alt': 'N', 'drug': 'levofloxacin', 'level': 'high'},
    {'id': 'gyrA_A90V', 'gene': 'gyrA', 'position': 90, 'ref': 'A', 'alt': 'V', 'drug': 'levofloxacin', 'level': 'high'},
    {'id': 'rrs_a1401g', 'gene': 'rrs', 'position': 1401, 'ref': 'A', 'alt': 'G', 'drug': 'amikacin', 'level': 'high'},
    {'id': 'rrs_c1402t', 'gene': 'rrs', 'position': 1402, 'ref': 'C', 'alt': 'T', 'drug': 'amikacin', 'level': 'high'},
    {'id': 'eis_-10G>A', 'gene': 'eis', 'position': -10, 'ref': 'G', 'alt': 'A', 'drug': 'kanamycin', 'level': 'moderate'},
    {'id': 'rpoC_V483G', 'gene': 'rpoC', 'position': 483, 'ref': 'V', 'alt': 'G', 'drug': 'rifampin', 'level': 'low'},
    {'id': 'Rv0678_137insG', 'gene': 'Rv0678', 'position': 137, 'ref': '-', 'alt': 'G', 'drug': 'bedaquiline', 'level': 'high'},
    {'id': 'rplC_C154R', 'gene': 'rplC', 'position': 154, 'ref': 'C', 'alt': 'R', 'drug': 'linezolid', 'level': 'high'},
]
...
strain_data = [
    {'strain': 'TB001', 'mutations': ['rpoB_S450L', 'katG_S315T'], 'profile': 'MDR'},
    {'strain': 'TB002', 'mutations': ['katG_S315N'], 'profile': 'MonoResistant'},
    {'strain': 'TB003', 'mutations': ['rpoB_S450L', 'katG_S315T', 'gyrA_D94G'], 'profile': 'PreXDR'},
    {'strain': 'TB004', 'mutations': ['inhA_-15C>T', 'embB_M306V'], 'profile': 'PolyResistant'},
    {'strain': 'TB005', 'mutations': ['katG_S315T', 'inhA_-15C>T'], 'profile': 'MonoResistant'},
    {'strain': 'TB006', 'mutations': ['rpoB_D435V', 'katG_S315N'], 'profile': 'MDR'},
    {'strain': 'TB007', 'mutations': ['embB_M306I'], 'profile': 'MonoResistant'},
    {'strain': 'TB008', 'mutations': ['katG_S315I'], 'profile': 'MonoResistant'},
    {'strain': 'TB009', 'mutations': ['rpoB_H445Y', 'katG_S315T', 'embB_M306V'], 'profile': 'MDR'},
    {'strain': 'TB010', 'mutations': ['inhA_-8T>C'], 'profile': 'MonoResistant'},
    {'strain': 'TB011', 'mutations': ['rpoB_S450L', 'katG_S315T', 'gyrA_D94G', 'rrs_a1401g'], 'profile': 'XDR'},
    {'strain': 'TB012', 'mutations': ['rpoB_S450L', 'rpoC_V483G', 'katG_S315T'], 'profile': 'MDR'},
    {'strain': 'TB013', 'mutations': ['rpoB_H445D', 'katG_S315N', 'gyrA_D94N'], 'profile': 'PreXDR'},
    {'strain': 'TB014', 'mutations': ['rpoB_L430P', 'katG_S315I', 'pncA_H57D'], 'profile': 'MDR'},
    {'strain': 'TB015', 'mutations': ['rpoB_D435V', 'inhA_-15C>T', 'embB_M306V', 'gyrA_D94G'], 'profile': 'PreXDR'},
    {'strain': 'TB016', 'mutations': ['katG_S315T'], 'profile': 'MonoResistant'},
    {'strain': 'TB017', 'mutations': ['inhA_-15C>T'], 'profile': 'MonoResistant'},
    {'strain': 'TB018', 'mutations': ['rpoB_S450L'], 'profile': 'MonoResistant'},
    {'strain': 'TB019', 'mutations': ['rpoB_H445Y', 'katG_S315T', 'pncA_W68R'], 'profile': 'MDR'},
    {'strain': 'TB020', 'mutations': ['katG_S315N', 'embB_M306I'], 'profile': 'PolyResistant'},
    {'strain': 'TB021', 'mutations': ['embB_M306V'], 'profile': 'MonoResistant'},
    {'strain': 'TB022', 'mutations': ['katG_S315T', 'pncA_H57D'], 'profile': 'PolyResistant'},
    {'strain': 'TB023', 'mutations': ['rpoB_H445Y', 'katG_S315N'], 'profile': 'MDR'},
    {'strain': 'TB024', 'mutations': ['inhA_-15C>T'], 'profile': 'MonoResistant'},
    {'strain': 'TB025', 'mutations': ['katG_S315I', 'embB_M306I'], 'profile': 'PolyResistant'},
    {'strain': 'TB026', 'mutations': ['rpoB_S450L', 'katG_S315T', 'gyrA_A90V'], 'profile': 'PreXDR'},
    {'strain': 'TB027', 'mutations': ['pncA_W68R'], 'profile': 'MonoResistant'},
    {'strain': 'TB028', 'mutations': ['katG_S315N'], 'profile': 'MonoResistant'},
    {'strain': 'TB029', 'mutations': ['embB_M306V', 'pncA_H57D'], 'profile': 'PolyResistant'},
    {'strain': 'TB030', 'mutations': ['inhA_-8T>C'], 'profile': 'MonoResistant'},
    {'strain': 'TB031', 'mutations': ['katG_S315T'], 'profile': 'MonoResistant'},
    {'strain': 'TB032', 'mutations': ['rpoB_D435V', 'katG_S315I'], 'profile': 'MDR'},
    {'strain': 'TB033', 'mutations': ['rpoB_H445D', 'katG_S315T'], 'profile': 'MDR'},
    {'strain': 'TB034', 'mutations': ['inhA_-15C>T', 'pncA_W68R'], 'profile': 'PolyResistant'},
    {'strain': 'TB035', 'mutations': ['rpoB_S450L', 'katG_S315N', 'gyrA_D94G', 'rrs_c1402t'], 'profile': 'XDR'},
    {'strain': 'TB036', 'mutations': ['embB_M306I'], 'profile': 'MonoResistant'},
    {'strain': 'TB037', 'mutations': ['katG_S315T', 'embB_M306V'], 'profile': 'PolyResistant'},
    {'strain': 'TB038', 'mutations': ['inhA_-15C>T'], 'profile': 'MonoResistant'},
    {'strain': 'TB039', 'mutations': ['rpoB_L430P', 'katG_S315T'], 'profile': 'MDR'},
    {'strain': 'TB040', 'mutations': ['pncA_H57D'], 'profile': 'MonoResistant'},
    {'strain': 'TB041', 'mutations': ['katG_S315N', 'embB_M306I', 'pncA_W68R'], 'profile': 'PolyResistant'},
    {'strain': 'TB042', 'mutations': ['rpoB_H445Y', 'katG_S315I', 'gyrA_D94N'], 'profile': 'PreXDR'},
    {'strain': 'TB043', 'mutations': ['embB_M306V'], 'profile': 'MonoResistant'},
    {'strain': 'TB044', 'mutations': ['katG_S315T'], 'profile': 'MonoResistant'},
    {'strain': 'TB045', 'mutations': ['rpoB_D435V', 'katG_S315N', 'gyrA_A90V'], 'profile': 'PreXDR'},
    {'strain': 'TB046', 'mutations': ['inhA_-8T>C'], 'profile': 'MonoResistant'},
    {'strain': 'TB047', 'mutations': ['katG_S315I', 'pncA_H57D'], 'profile': 'PolyResistant'},
    {'strain': 'TB048', 'mutations': ['rpoB_S450L'], 'profile': 'MonoResistant'},
    {'strain': 'TB049', 'mutations': ['rpoB_H445D', 'katG_S315T', 'gyrA_D94G'], 'profile': 'PreXDR'},
    {'strain': 'TB050', 'mutations': ['katG_S315N'], 'profile': 'MonoResistant'},
...
class TBOntology:
    ...
    def _mutations(self):
        ...
        self._batch("""
            ...
            MERGE (m)-[:CONFERS_RESISTANCE {level: row.level}]->(d)
        """, mutations)
            ...
            for batch in catalog.batch_mutations(batch_size=1000):
                session.run("""
                    ...
                    SET m.confidence = mut.confidence,
                        m.tier = mut.tier
                    MERGE (m)-[:IN_GENE]->(g)
                    MERGE (m)-[:CONFERS_RESISTANCE {level: mut.confidence}]->(d)
                """, {'mutations': batch})
                total += len(batch)
